    ...
    <div class="cntct-shwcs-main-sub about-sub">
      ...
      <div class="carousels-container">
        <div class="carousel" :style="{ transform: `rotateY(${currentAngle}deg)` }">
          <div class="hobby-card1 hobbies-cards">
          ...
          <div class="hobby-card2 hobbies-cards">
            <div class="flip-inner">
          ...
          <div class="hobby-card3 hobbies-cards">
            <div class="flip-inner">
          ...
          <div class="hobby-card4 hobbies-cards">
            <div class="flip-inner">
          ...
          <div class="hobby-card5 hobbies-cards">
            <div class="flip-inner">
